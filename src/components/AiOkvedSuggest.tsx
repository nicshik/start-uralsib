...
const KEYWORD_MAP: Record<string, string[]> = {
  ...
  // Животные
  "зоо": ["47.76", "96.09"],
  "ветеринар": ["75.00", "96.09"],
  "груминг": ["96.09"],
  "питомц": ["96.09"],
  "корм": ["47.76", "10.89"],
  // Фриланс и услуги
  "фриланс": ["62.01", "74.10", "73.11"],
  "копирайт": ["73.11", "58.11"],
  "контент": ["73.11", "63.12"],
  "блог": ["63.12", "73.11"],
  "стрим": ["59.11", "63.12"],
  // Мероприятия
  "мероприят": ["82.30", "90.02"],
  "свадьб": ["82.30", "74.20"],
  "праздник": ["82.30", "93.29"],
  "ведущ": ["90.01", "82.30"],
  "тамада": ["90.01", "82.30"],
  "организац": ["82.30"],
  // Стирка и быт
  "прачечн": ["96.01"],
  "химчистк": ["96.01"],
  // Открыть бизнес (общие)
  "открыть": ["47.19", "56.10", "47.91"],
  "бизнес": ["70.22", "82.99"],
  "стартап": ["62.01", "70.22"],
  "франшиз": ["47.19", "56.10"],
};
