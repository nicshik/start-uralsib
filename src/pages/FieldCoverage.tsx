...
export default function FieldCoverage() {
  ...
  const missingOOO = [
    ...
    "Место рождения учр.", "Адрес рег. учредителя",
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <Card className="p-8">
              <h3 className="text-xl font-medium text-foreground mb-6 flex items-center justify-between">
                ...
                <span className="bg-brand-light text-muted-foreground px-3 py-1 rounded-lg text-sm">~7 полей</span>
              </h3>
            ...
            <Card className="p-8">
              <h3 className="text-xl font-medium text-foreground mb-6 flex items-center justify-between">
                ...
                <span className="bg-accent text-primary px-3 py-1 rounded-lg text-sm">~17 полей</span>
              </h3>
